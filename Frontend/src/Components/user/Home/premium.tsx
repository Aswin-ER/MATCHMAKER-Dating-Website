        ...
        <>
            <div className=' grid grid-col-12 grid-row-12 mt-20 mb-18'>
                ...
                <div className='grid col-start-9 col-end-11 row-start-3 row-end-4 lg:items-center  w-10/12 lg:mt-50 md:mt-16'>
                    <p className='lg:text-2xl md:text-lg mobile:text-sm font-medium'>Enjoy the benefits of our dating services membereship! Use the psychological matching to find the best people and experience other great bonuses.</p>
                    <button className='lg:text-lg bg-pink-700 hover:bg-pink-500 font-medium lg:mb-50 lg:w-3/12 md:w-4/12 mobile:w-7/12 lg:p-1 mobile:p-1 mobile:mt-4 text-center' onClick={() => navigate('/plans')}>View Plans</button>
                </div>
            </div>
        </>
    );
