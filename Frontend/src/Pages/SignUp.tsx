      ...
      <div className="container md:w-8/12 lg:w-6/12 xl:w-4/12 mx-auto px-4 mt-6 md:mt-16 bg-pink-100 p-8 rounded-lg shadow-lg">
        ...
        <form className="flex flex-col items-center">
          <div className="mb-6 w-4/5">
            ...
            <input
              type="text"
              className="block w-full px-4 py-2 mt-1 text-lg md:text-lg bg-white border border-gray-300 rounded focus:outline-none focus:ring focus:ring-pink-500 focus:border-pink-500"
              value={name}
          ...
          <div className='text-base ml-14 mb-4 font-semibold text-red-700'>{err ? err : ""}</div>
            <button onClick={handleSubmit} type='button' className="w-full px-6 py-3 text-lg md:text-xl font-medium text-white transition-colors duration-200 transform bg-pink-700 rounded-md hover:bg-pink-600 focus:outline-none focus:bg-pink-600">
              Create Account
            </button>
          </div>
        </form>
